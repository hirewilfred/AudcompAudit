...
export const ADVISOR_STEPS: AdvisorStep[] = [
    ...
    {
        id: 'department_gaps',
        title: 'Department gaps where an AI agent could help',
        subtitle: 'Pick the single biggest gap in each department. We\'ll match every gap to a specific AI agent and book you with an AI Expert to scope the build.',
        fields: [
            {
                id: 'gap_sales',
                label: 'Sales — biggest gap an AI agent could close',
                type: 'radio',
                options: [
                    { value: 'lead_qualification', label: 'Lead qualification & scoring', description: 'Reps waste time on bad-fit leads' },
                    { value: 'outreach', label: 'Cold outreach & follow-up', description: 'Personalized messaging at scale' },
                    { value: 'crm_hygiene', label: 'CRM updates & note-taking', description: 'Reps don\'t log activity reliably' },
                    { value: 'forecasting', label: 'Pipeline forecasting', description: 'Hard to predict close probabilities' },
                    { value: 'proposal_writing', label: 'Proposal & quote drafting', description: 'Slow turnaround on RFPs / SOWs' },
                    { value: 'none', label: 'No major gap right now', description: 'Sales is operating well' },
                ],
            },
            {
                id: 'gap_marketing',
                label: 'Marketing — biggest gap an AI agent could close',
                type: 'radio',
                options: [
                    { value: 'content_creation', label: 'Content & copy production', description: 'Blogs, captions, ad copy at volume' },
                    { value: 'social_scheduling', label: 'Social media scheduling & engagement', description: 'Multi-channel posting + DM replies' },
                    { value: 'email_campaigns', label: 'Email campaigns & nurture sequences', description: 'Drip flows, segmentation, A/B testing' },
                    { value: 'seo', label: 'SEO & keyword research', description: 'Topic clusters, on-page audits' },
                    { value: 'analytics', label: 'Performance reporting', description: 'Cross-channel attribution & dashboards' },
                    { value: 'none', label: 'No major gap right now', description: 'Marketing is operating well' },
                ],
            },
            {
                id: 'gap_customer_service',
                label: 'Customer Service — biggest gap an AI agent could close',
                type: 'radio',
                options: [
                    { value: 'tier1_tickets', label: 'Tier-1 tickets & FAQs', description: 'Same questions over and over' },
                    { value: 'after_hours', label: 'After-hours coverage', description: 'No support outside business hours' },
                    { value: 'live_chat', label: 'Website live chat & lead capture', description: 'Visitors leave without a touchpoint' },
                    { value: 'feedback_analysis', label: 'Reviews & feedback analysis', description: 'Surfacing themes from open text' },
                    { value: 'escalation_routing', label: 'Smart escalation & routing', description: 'Right ticket to the right rep' },
                    { value: 'none', label: 'No major gap right now', description: 'Service is operating well' },
                ],
            },
            {
                id: 'gap_operations',
                label: 'Operations / Admin — biggest gap an AI agent could close',
                type: 'radio',
                options: [
                    { value: 'data_entry', label: 'Manual data entry between systems', description: 'Copy/paste between apps' },
                    { value: 'document_extraction', label: 'Document & form extraction', description: 'Invoices, POs, contracts, claims' },
                    { value: 'scheduling', label: 'Scheduling & coordination', description: 'Bookings, dispatch, inventory' },
                    { value: 'sop_knowledge', label: 'SOP & internal knowledge search', description: 'Staff can\'t find policies/answers' },
                    { value: 'compliance_audits', label: 'Compliance & audit prep', description: 'Tracking, evidence collection' },
                    { value: 'none', label: 'No major gap right now', description: 'Ops is operating well' },
                ],
            },
            {
                id: 'gap_finance_hr',
                label: 'Finance / HR — biggest gap an AI agent could close',
                type: 'radio',
                options: [
                    { value: 'ap_invoice', label: 'AP invoice processing & matching', description: 'Invoices to POs to receipts' },
                    { value: 'cashflow_forecast', label: 'Cash flow & budget forecasting', description: 'Ongoing rolling forecasts' },
                    { value: 'expense_review', label: 'Expense review & policy enforcement', description: 'Catching anomalies' },
                    { value: 'recruiting_screen', label: 'Recruiting & candidate screening', description: 'High volume of resumes' },
                    { value: 'onboarding_offboarding', label: 'Onboarding / offboarding workflow', description: 'Provisioning, paperwork, training' },
                    { value: 'none', label: 'No major gap right now', description: 'Finance / HR is operating well' },
                ],
            },
        ],
    },
