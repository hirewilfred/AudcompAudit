                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b border-slate-100 bg-slate-50/50">
                                        {['Company', 'Agreement', 'Contact', 'Monthly $', 'Contract End', 'M365 Users', 'Status', 'Actions'].map(h => (
                                            ...
                                            <tr key={client.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                                                <td className="py-4 px-4">
                                                    ...
                                                    {client.billing_cycle && client.billing_cycle !== 'Monthly' && (
                                                        <span className="text-[10px] font-black uppercase bg-amber-50 text-amber-600 px-2 py-0.5 rounded-full">{client.billing_cycle}</span>
                                                    )}
                                                </td>
                                                <td className="py-4 px-4">
                                                ...
                                                <td className="py-4 px-4">
                                                    {actual === null ? (
                                                        <span className="bg-slate-100 text-slate-400 text-[10px] font-black px-3 py-1 rounded-full uppercase">No Sync</span>
                                                    ) : isOver ? (
