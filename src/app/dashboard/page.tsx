...
export default function DashboardPage() {
    ...
    const [advisorResponses, setAdvisorResponses] = useState<Record<string, any> | null>(null);
        ...
        async function fetchResults() {
            try {
                ...
                try {
                    ...
                    if (advisorData?.responses) {
                        setAdvisorResponses(advisorData.responses);
                    }
            ...
            <main className="mx-auto max-w-7xl px-10 pt-12 pb-24 relative z-10">
                ...
                {(() => {
                    ...
                    const flagged = gapKeys
                        .map(k => ({ key: k, value: (advisorResponses?.[k] as string) || 'none' }))
